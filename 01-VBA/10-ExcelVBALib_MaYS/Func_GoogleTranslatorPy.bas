'Attribute VB_Name = "Sub_GoogleTranslatorPy"
Public Declare PtrSafe Sub Sleep Lib "kernel32" (ByVal dwMilliseconds As LongPtr)
Option Explicit
Public sDetectedLanguageCode

Public Sub GoogleTransPyScript()
'
...
' 4th Column: A empty column that will call the GoogleTransPyScript() function. This column will be filled with "Tranlated and Copied" when the translation is done.
...
'------------------------------------------------------
    ...
    If Len(UnTranslatedTextSubstitued) < MAX_CHAR_LIMIT_PER_REQUEST Then
        ...
        TranslatedText = GoogleTransPyScript(UnTranslatedTextSubstitued, LanguageCode)
...
'This Segement is for long Text that exceed the 10000 Characters Limit for each Request
    ...
    Else
        ...
        For i = 0 To nNrSegmentLongText - 1
            ...
            TranslatedLongTextSegmented(i) = GoogleTransPyScript(LongTextSegmented(i), LanguageCode)
    ...
    '     TranslatedText = GoogleTransPyScript(LongTextSegmented1, LanguageCode)
    '     DoEvents
