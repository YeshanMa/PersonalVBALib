Attribute VB_Name = "Sub_BOMStructureView"
...
BOM_LEVEL_COLOR_1 = RGB(254, 246, 254)
BOM_LEVEL_COLOR_2 = RGB(221, 221, 221)
BOM_LEVEL_COLOR_3 = RGB(206, 223, 206)
BOM_LEVEL_COLOR_4 = RGB(189, 207, 189)
BOM_LEVEL_COLOR_5 = RGB(128, 206, 128)
BOM_LEVEL_COLOR_6 = RGB(148, 186, 148)
BOM_LEVEL_COLOR_7 = RGB(99, 154, 99)
BOM_LEVEL_COLOR_8 = RGB(102, 144, 102)
BOM_LEVEL_COLOR_9 = RGB(179, 188, 179)
BOM_LEVEL_COLOR_10 = RGB(141, 150, 141)
BOM_LEVEL_COLOR_11 = RGB(115, 124, 115)
BOM_LEVEL_COLOR_12 = RGB(89, 97, 89)
...
sNrofBOMLevel = Replace(Expression:=sExtractedNrofBOMLevel, Find:="бн", Replace:="")
